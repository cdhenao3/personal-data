...
let AcademicService = class AcademicService {
    constructor(academicDataRepository) {
    ...
    async createAcademicData(id, createAcademicDataRepository) {
        const academicData = this.academicDataRepository.create(Object.assign(Object.assign({}, createAcademicDataRepository), { personalData: { id } }));
        return this.academicDataRepository.save(academicData);
    }
};
AcademicService = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, typeorm_1.InjectRepository)(typeorm_3.AcademicData)),
